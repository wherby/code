...
def get_prime(n):
    ...
    #print(visited[:20])
    return visited
# https://leetcode.cn/problems/apply-operations-to-maximize-score/submissions/
pls = get_prime(10**5) # move the initialization to global which could reduct running time 
class Solution:
