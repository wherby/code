...
class Solution:
    def maxValue(self, nums1: list[int], nums0: list[int]) -> int:
        ...
        for i in range(n):
            a,b = nums1[i],nums0[i]
            ls.append((a,b))
        def encode(u1, v1, u2, v2, first_is_1):
            L1, L2 = u1 + v1, u2 + v2
        ...
        def compare(f1, f2):
            ...
            code_ab = encode(u1, v1, u2, v2, True)
            code_ba = encode(u1, v1, u2, v2, False)
            print(f1,f2, code_ab,code_ba, code_ab>code_ba)
            if code_ab > code_ba:
                return -1 
            elif code_ab < code_ba:
                return 1  
            return 0
