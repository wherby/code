...
#re = Solution().maxCandies(status = [1,0,1,0], candies = [7,5,4,100], keys = [[],[],[1],[]], containedBoxes = [[1,2],[3],[],[]], initialBoxes = [0])
re = Solution().maxCandies(status  , candies , keys, containedBoxes , initialBoxes)
print(re)