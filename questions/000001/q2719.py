...
class Solution:
    def count(self, num1: str, num2: str, min_sum: int, max_sum: int) -> int:
        @cache
        def f(i: int, is_limit: int, is_num: int,s:str) -> int:
            if i == len(s): 
            ...
            return res
        #print( f(0,True,0,num2))
        mod = 10**9+7
        return (f(0,True,0,num2) - f(0,True,0,str(int(num1) -1)))%mod
print("aa")
re =Solution().count( num1 = "1", num2 = "12", min_sum = 1, max_sum = 8)
print(re)