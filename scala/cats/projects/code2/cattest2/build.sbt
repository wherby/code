...
val gh = GitHubSettings(org = "io.github.wherby", proj = "cattest2", publishOrg = "io.github.wherby", license = apache2)

val mainDev =
  Developer("wherby", "@yourhandler_without_@", "whereby@live.cn", new java.net.URL("http://github.com/yourhandler_without_@"))
...
lazy val Cattest2 = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "cattest2"),
    micrositeDocumentationUrl := "/cattest2/api/catstarter/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "io.github.wherby"
  )
