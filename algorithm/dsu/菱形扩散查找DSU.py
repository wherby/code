# 使用DSU维护每个点左右的可用点，然后用距离向上或者向下移动获得最小的菱形点
# DSU 维护合并，用L,R数组维护根节点的左右边界端点
# https://codeforces.com/problemset/problem/200/A
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2025/04/0419/solution/cf200a.md

import sys
sys.path.append("..")
from cflibs.cflibs import *
from codeforce.lib.UnionFind import UnionFind
def main():
    n, m, q = MII()
