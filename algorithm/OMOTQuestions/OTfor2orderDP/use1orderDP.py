# https://leetcode.cn/problems/minimum-operations-to-achieve-at-least-k-peaks/submissions/715289916/
# use 2 of 1 order DP instead of 2 order dp  only cost 4S if use 2 order DP will cost 12S 
