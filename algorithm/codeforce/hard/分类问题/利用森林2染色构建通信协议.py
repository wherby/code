# https://codeforces.com/gym/106414/problem/H
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2026/05/0511/solution/cf106414h.md
#  algorithm/codeforce/lib/TwoSat.py is not verified



import init_setting
from cflibs import *
from lib.TwoSat import *
def main(): 
    s = I()
    if s == 'first':
        t = II()
