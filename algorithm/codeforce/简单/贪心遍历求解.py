# https://codeforces.com/gym/106141/problem/L
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2026/05/0518/solution/cf106141l.md
# 乘3的数字越大越好。这里可以贪心排序之后计算，所以可能的分割点都需要计算，这里不能用二分查找分割点
