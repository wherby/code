...
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2026/06/0612/solution/cf105383l.md
# 这个题目需要刚好K步从S到T，由于K很大，则需要采用倍增的方式计算，采用quickPow的方式计算刚好k1的路径
# 而在里面要求字典序最小的路径，所以在倍增或者Merge的时候需要采用前缀字符串的类似算法，使用逻辑顺序排序，同时维护两点之间的最短距离和相对的顺序大小
# 
