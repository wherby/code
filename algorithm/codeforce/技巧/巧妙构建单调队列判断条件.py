# https://codeforces.com/gym/106270/problem/E
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2025/12/1224/solution/cf106270e.md
# 利用条件构建单独队列,
# 分析条件中的约束
#  ans = 1 if pos[nums[idx]][0] == idx else rev2  如果是起始点初始概率是1,如果起始点在前面,无论前面有多少个相同的,初始概率都是1/2, 后面每一个降低1/2的几率
