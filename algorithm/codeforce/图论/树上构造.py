# https://codeforces.com/gym/106170/problem/A
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2025/11/1108/solution/cf106170a.md
# 对数上边染色，找到最大的K值，使得每个边出发都有K个不同的颜色
# 找到K 很容易，看每个点到直径两个点的最大值的最小值，就确保这个点能有K个线段
# 如何构造性编码，使得我们能找到从任一线段(或者边/点) 出发的k个线段都是不同颜色的
# 构造的时候，先确定直径，然后用直径中间为端点，开始编号，这样，每条边，都让终点在直径上就可以了，在编号对的时候，根据当前点到两个直径端点的距离确定编号序号？ 
