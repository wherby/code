...
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2025/10/1022/solution/cf105139i.md
# 计算动态生成的森林中的最大路径长度
# 利用UF 记录当前森林的根。
# 随时记录了连接两端区域的直径长度和端点，更新连接之后的直径长度和直径端点

import init_setting
from cflibs import *
from lib.UnionFind import * 
from lib.sparsetable import *
def main(): 
    t = II()
    outs = []
