# https://leetcode.com/contest/weekly-contest-480/problems/minimum-deletions-to-make-alternating-substring/
    ...
    def minDeletions(self, s: str, queries: List[List[int]]) -> List[int]:
        ...
        for q in queries:
            if q[0] == 1:
                ...
                s2 = "B" if s1 =="A" else "A"
                s3 = [s2,s2,0]
                seg.set_value(idx,s3)
                ss[idx] =s3 
            else:
                f,t = q[1],q[2]
                ret.append(seg.prod(f,t+1)[2])
        return ret




re =Solution().minDeletions(s = "ABA", queries = [[2,1,2],[1,1],[2,0,2]])
print(re)