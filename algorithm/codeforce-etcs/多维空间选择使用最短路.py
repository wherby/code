# 多维空间的标准最短路问题，“algorithm/codeforce-etcs/多维空间选择不能直接用最短路径.py” cost函数条件不一样
# https://codeforces.com/problemset/problem/676/D
# https://github.com/Yawn-Sean/Daily_CF_Problems/blob/main/daily_problems/2025/04/0417/solution/cf676d.md
